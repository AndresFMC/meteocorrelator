...
plt.figure(figsize=(15, 7))  # Puedes ajustar el tamaño para mejor visualización
...
plt.gca().xaxis.set_minor_locator(mdates.DayLocator(interval=1))  # Coloca marcas menores cada día
